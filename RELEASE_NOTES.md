...
- **Sign in, and stay signed in.** Connect to your NAS with your account. An
  ...
  no retyping your password.
- **Browse and manage your files.** A full File Station: move through shared
  ...
  and expiry date).
- **Check system info.** Your NAS model, DSM version, uptime and more, at a glance.
- **Keep an eye on storage.** Volumes and disks with their health, temperature
  and capacity, plus storage pools/RAID, inode usage and bad-sector counts.
- **Watch live resource usage.** Real-time CPU, memory and network activity.
...
[dsmaccess-1.0.zip](https://github.com/math65/dsmaccess/releases/download/v1.0/dsmaccess-1.0.zip)
